...
//		}
//
//		for(double rho = 0.008; rho<0.2; rho+=0.001) {
//			for(double threshold = 1.5; threshold<12; threshold+=0.5) {
//				for(int t=2; t<=700; ++t) {
//					//choosing N frames
...
//						path = String.format("/Users/adithiathreya/Desktop/SCU/COEN296-VideoProcessing/office/Compare/in%06d_%1.4f_%1.2f.jpg", t,rho,threshold);
